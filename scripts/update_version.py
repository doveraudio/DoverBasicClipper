...
def main():
  ...
  plistpath = scriptpath + "/resources/DoverBasicClipper-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DoverBasicClipper-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DoverBasicClipper-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DoverBasicClipper-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DoverBasicClipper-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/DoverBasicClipper.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/DoverBasicClipper.iss",inplace=1):
