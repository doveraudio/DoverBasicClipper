...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=DoverBasicClipper Demo Installer\n"
      else:
        line="OutputBaseFilename=DoverBasicClipper Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the DoverBasicClipper Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the DoverBasicClipper installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=DoverBasicClipper Demo installer\n"
     else:
       line="SetupWindowTitle=DoverBasicClipper installer\n"
